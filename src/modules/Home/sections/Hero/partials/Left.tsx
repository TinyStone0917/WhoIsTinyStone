    ...
    <div  className='relative col-span-2 z-10 md:text-center lg:text-left !mt-[-20px] ' >
        ...
        <div className='relative' >
            <div>
               <AnimatedTextWord 
                  text="Hi, my name is"
                  className='text-sm text-white sm:text-lg justify-center lg:justify-start'
               />
            </div>
            <div>
            ...
            <div className='my-5 md:my-8 leading-7 text-slate-400 md:text-lg max-w-3xl' >
               <AnimatedTextWord 
                  text="Highly motivated and very passionate Full Stack Developer with 5 years of experience in Typescript, React js, Next js, Firebase, Tailwind CSS, Material UI, Node js, Express js, MongoDB"
